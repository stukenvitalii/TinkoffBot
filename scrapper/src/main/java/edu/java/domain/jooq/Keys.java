...
public class Keys {
    ...
    public static final UniqueKey<SofLinkPropertiesRecord> PK_SOF_LINK_PROPERTIES = Internal.createUniqueKey(
        SofLinkProperties.SOF_LINK_PROPERTIES,
        DSL.name("PK_SOF_LINK_PROPERTIES"),
        new TableField[] {SofLinkProperties.SOF_LINK_PROPERTIES.ID},
        true
    );
}
