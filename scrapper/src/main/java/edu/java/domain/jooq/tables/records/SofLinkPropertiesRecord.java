...
public class SofLinkPropertiesRecord extends UpdatableRecordImpl<SofLinkPropertiesRecord> implements Record4<Long, Long, Long, Long> {
    ...
    @Override
    @NotNull
    public SofLinkPropertiesRecord values(@NotNull Long value1, @NotNull Long value2, @NotNull Long value3, @NotNull Long value4) {
        value1(value1);
        value2(value2);
        value3(value3);
        value4(value4);
    ...
    public SofLinkPropertiesRecord(@NotNull Long id, @NotNull Long linkId, @NotNull Long answerCount, @NotNull Long commentCount) {
        super(SofLinkProperties.SOF_LINK_PROPERTIES);
